        ...
        <MenuItems
            ...
            <div class="px-1 py-1">
                <MenuItem v-slot="{ active }">
                   <a class="text-grey-700 block px-4 py-2 text-sm">New Folder</a>
                </MenuItem>
            </div>
            <div class="px-1 py-1">
                <MenuItem v-slot="{ active }">
                    <a class="text-grey-700 block px-4 py-2 text-sm">Upload File(s)</a>
                </MenuItem>
                <MenuItem v-slot="{ active }">
                    <a class="text-grey-700 block px-4 py-2 text-sm">Upload Folder</a>
                </MenuItem>
            </div>
            </MenuItems>
      </transition>
